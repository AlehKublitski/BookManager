...
<html>
<head>
    <title>Select only no needede</title>
...
<h1>Перечень опционных деталей</h1>
...
<c:if test="${allNoNeeded.size() > listParts.size()}">
    <table>
        <tr>
            <td><a href="<c:url value='/previous/noneeded'/>"><<Предыдущие<<  </a></td>
            <td><a href="<c:url value='/next/noneeded'/>">  >>Следующие>></a></td>
